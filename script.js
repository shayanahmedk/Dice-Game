...
// track dice values
let diceValuesArr = [];
// track current/total score, no of rolls, current round
let rolls = 0;
let score = 0;
let totalScore = 0;
let round = 1;
...
// roll dice function
const rollDice = () => {
    diceValuesArr = [];    // reset prev dice values

    for(let i=0; i<5; i++) {    //random num genrator
...
rulesBtn.addEventListener('click', () => {
    isModalShowing = !isModalShowing;   //invert value
